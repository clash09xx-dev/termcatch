        ...
        <div className="bg-white border border-surface-100 rounded-2xl p-6">
          <div className="flex items-start gap-8">
            ...
            <div className="text-center flex-shrink-0">
              ...
              <p className="text-xs text-surface-700 mt-1">{totalCount} opinii</p>
            </div>
              ...
              {starDistribution.map(({ star, count, pct }) => (
                <div key={star} className="flex items-center gap-3">
                  <div className="flex items-center gap-1 w-12 flex-shrink-0">
                    <span className="text-xs text-surface-700">{star}</span>
                  ...
                  <span className="text-xs text-surface-700 w-6 text-right">{count}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {reviews.length === 0 ? (
        <div className="bg-white border border-surface-100 rounded-2xl flex flex-col items-center justify-center py-20 text-center px-6">
          <div className="w-12 h-12 rounded-full bg-surface-100 flex items-center justify-center mb-4">
            <StarIcon className="w-6 h-6 text-surface-700" />
          </div>
            ...
            >
              ...
              {review.replyText && replyingTo !== review.id && (
                <div className="mt-4 pl-4 border-l-2 border-brand-200">
                  <p className="text-xs font-semibold text-brand-600 mb-1">Odpowiedź salonu</p>
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-sm px-3 py-2 border border-surface-200 text-gray-900 hover:bg-surface-50 rounded-xl transition-colors font-medium"
                    >
                      Anuluj
                    </button>
                    <button
