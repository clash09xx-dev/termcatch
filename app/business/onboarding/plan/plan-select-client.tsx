...
const INK = { background: "var(--ink-raised)", color: "#F8FAFC", border: "1px solid #0F172A" };
    ...
    <div className="min-h-screen px-6 py-14" style={{ background: BG }}>
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2" style={{ letterSpacing: "var(--track-display)", color: "#0F172A" }}>
        ...
        {!billingReady && (
          <div className="max-w-2xl mx-auto mb-6 px-5 py-3.5 rounded-2xl text-sm" style={{ background: "var(--surface)", border: "1px solid var(--hairline-firm)", color: "#475569" }}>
          ...
          {PLAN_CATALOG.map((plan) => {
            ...
            return (
              <button
                ...
                disabled={pending}
                aria-pressed={active}
                className="text-left p-5 rounded-2xl transition-colors btn-spring disabled:opacity-60"
                style={{
                  background: active ? "rgba(241,246,251,0.95)" : "rgba(255,255,255,0.72)",
                  border: active ? "1.5px solid #0F172A" : "1px solid var(--hairline)",
                  boxShadow: active
              ...
              >
                ...
                <div className="flex items-baseline gap-1 mt-1 mb-2">
                  <span className="text-2xl font-bold" style={{ color: "#0F172A", letterSpacing: "var(--track-display)" }}>{plan.price}</span>
          ...
          <div className="max-w-md mx-auto mb-6">
            ...
            <div className="flex gap-2">
              <input
                ...
                style={{ background: "var(--surface)", border: "1px solid var(--hairline)", color: "#0F172A" }}
              />
              <button
                type="button"
                onClick={applyCode}
